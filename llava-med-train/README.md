...
python3 -m llava.model.apply_delta \
    --base /data0/GYF/offline_model/llama-7B \
    --target /home/guoyunfei/projects/llava-med-train/output/llava-vicuna-7b \
    --delta /data0/GYF/offline_model/liuhaotian/LLaVA-7b-delta-v0
```
