...
# hyper-parameters
GPUS=4
model_name_or_path=/data0/GYF/offline_model/liuhaotian/llava-v1.6-vicuna-7b #/llava-vicuna-7b-pretrain_cc3m_595k_1e-instruct_158k-3epoch
output_dir=/workspace/research/output/llava-vicuna-7b/med-pretrain-12W-debug
data_path=/data0/GYF/data/llava-med/data/llava_med_alignment_10k-2024072902.json
image_folder=/data0/GYF/data/llava-med/images
vision_tower=/data0/GYF/offline_model/openai/clip-vit-large-patch14-336 # microsoft/BiomedCLIP-PubMedBERT_256-vit_base_patch16_224
