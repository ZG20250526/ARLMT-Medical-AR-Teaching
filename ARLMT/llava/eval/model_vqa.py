...
#     patch_dict = {
#         "use_mm_proj": True,
#         "mm_vision_tower": "/data0/GYF/offline_model/openai/clip-vit-large-patch14-336",
#         "mm_hidden_size": 1024
#     }
#
...
def eval_model(args):
    ...
    if args.mm_projector is None:
        ...
        if mm_use_im_start_end:
            ...
            special_tokens_dict["additional_special_tokens"].extend([DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN])
        ...
        #Resize model's token embeddings to match the tokennize size
        model.resize_token_embeddings(len(tokenizer))
        ...
        if mm_use_im_start_end:
            ...
            special_tokens_dict["additional_special_tokens"].extend([DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN])
        #Add new special tokens to the tokenizer
        num_added_token = tokenizer.add_special_tokens(special_tokens_dict)
