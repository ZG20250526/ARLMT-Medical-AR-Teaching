...
deepspeed /home/guoyunfei/projects/LLaVA-main/llava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /data0/GYF-projects/LLaVA-main/LLaVA-main/playground/llava_v1_6_mix665k+med2024090801.json \
    ...
    --bf16 True \
    --output_dir /home/guoyunfei/projects/LLaVA-main/llava/checkpoints/20250514-llava-v1.6-vicuna-13b-llava_v1_6_mix665k+med2024090801-finetune_qlora \
    --num_train_epochs 1 \
